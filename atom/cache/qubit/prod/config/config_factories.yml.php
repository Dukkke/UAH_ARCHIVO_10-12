...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'warning',
  'file' => '/var/www/html/log/qubit_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  {
    $class = sfConfig::get('sf_factory_i18n', 'sfTranslateI18N');
    $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/html/cache/qubit/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/html/apps/qubit/template',
));
  ...
  $class = sfConfig::get('sf_factory_response', 'QubitWebResponse');
  ...
  $class = sfConfig::get('sf_factory_routing', 'QubitPatternRouting');
      $cache = null;
...
if ($parameters = $this->factories['routing']->parse($this->factories['request']->getPathInfo()))
{
  ...
  $class = sfConfig::get('sf_factory_storage', 'QubitSessionStorage');
